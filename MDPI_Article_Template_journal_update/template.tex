...
\midrule
WL2 median wavelength & Median wavelength of the target FBG channel within the current peak-centered response. \\
WL2 wavelength spread & Standard deviation of the target-channel wavelength within the current response. \\
WL2 shift from run baseline & Median WL2 wavelength minus the median WL2 wavelength of the first loading group of the same run. \\
...
Change in WL2 baseline shift & Difference between the current and previous values of the WL2 shift from run baseline within the same run. \\
